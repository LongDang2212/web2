...
<table width="200" border="1">
  ...
  <tr>
    ...
    <td>
      <input type="text" name="product_inventory" id="product_inventory" value="<?php echo $row['product_inventory'] ?>" /></td>
  </tr>
  <tr>
    <td>Product_historical_cost</td>
    <td>
      <input type="text" name="product_historical_cost" id="product_historical_cost" value="<?php echo $row['product_historical_cost'] ?>" /></td>
  </tr>
  <tr>
    <td>Product_price</td>
    <td>
    ...
    <td>
      ...
      <?php
			...
			while($dong_cat=mysql_fetch_array($cat)){
				if($dong_cat['product_cat']==$row['product_cat']){
	  ?>	
      				<option value="<?php echo $dong_cat['product_cat'] ?>" selected="selected"><?php echo $dong_cat['tenloai'] ?></option>
      <?php
			}else{?>
				<option value="<?php echo $dong_cat['product_cat'] ?>"><?php echo $dong_cat['tenloai'] ?></option>
    ...
    <td>  <select name="product_brand" id="product_brand">
      <?php
			...
			while($dong=mysql_fetch_array($hieu)){
				if($dong['product_brand']==$row['product_brand']){
	  ?>	
      				<option value="<?php echo $dong['product_brand'] ?>" selected="selected"><?php echo $dong['tenhieu'] ?></option>
      <?php
			}else{?>
	 			<option value="<?php echo $dong['product_brand'] ?>"><?php echo $dong['tenhieu'] ?></option>
      <?php
			}
			}
	  ?>
